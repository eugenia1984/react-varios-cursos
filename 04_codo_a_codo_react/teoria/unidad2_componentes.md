# <img src="https://img.icons8.com/emoji/24/000000/check-mark-button-emoji.png"/> Componentes * Unidad 2
...
-> Y en el return del componente agregamos una llave y escribimos las children. Al hacer esto, **React montara dicha propiedad como componentes en nuestra DOM**.
...
Puedes empezar a aprender Hooks en la siguiente página. 

En esta página, continuaremos explicando por qué estamos agregando Hooks a React y cómo estos pueden ayudarte a escribir aplicaciones grandiosas.
