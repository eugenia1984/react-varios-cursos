...
![image](https://user-images.githubusercontent.com/72580574/226191871-4c9d9fa6-50b9-4dc1-80f4-d2cdc7d69e90.png)
...
-Ejemplos: `````` ->  -lh``` -> ver objetos en el directorio actual estructurados de manera ordenada, ```ls usr/bin | wc -l``` ->cuenta cantidad de objetos en el directorio “usr/bin”
...
![image](https://user-images.githubusercontent.com/72580574/226192482-ff4b3054-9424-47fe-8193-57ab81cdfdf6.png)
...
4. Ingresamos al directorio de la aplicación

5. Nos aseguramos estar dentro de la carpeta raíz del proyecto y ahí ejecutar la siguiente línea de comandos

```npm start```

5. Finalmente, iniciamos la compilación del proyecto para visualizarlo en un navegador web

6. Les recordamos que también podemos ejecutar la terminal de línea de comandos desde Visual Estudio Code

![image](https://user-images.githubusercontent.com/72580574/226192558-f1da93f2-c751-4f14-827b-745fc143bae0.png)
