...
![image](https://user-images.githubusercontent.com/72580574/229248525-4d88a43c-4346-46ac-882c-6357732211e2.png)
...
![image](https://user-images.githubusercontent.com/72580574/229248564-52f32719-c545-45cf-a677-f08fca52deb8.png)


- **Componente funcional**:

![image](https://user-images.githubusercontent.com/72580574/229248595-46700409-6c79-4743-8b45-9b39da3d903d.png)
...
Al desarrollar crearemos componentes para resolver pequeños distintos problemas, que son fáciles de visualizar y comprender durante el proceso de desarrollo, por lo cual nos ahorrar mucho tiempo.
 ...
 ![image](https://user-images.githubusercontent.com/72580574/229248637-d1039d5f-768c-4df6-b799-1c83de35728b.png)
...
- depuración, escalabilidad, etc.

A menudo, las actualizaciones se convierten en un problema porque la aplicación tiene una lógica compleja y los cambios en un componente pueden afectar a otros.

Para resolver el problema, Facebook ha complementado React con la capacidad de **reutilizar componentes** del sistema, y ​​los desarrolladores lo definen como una de las mejores características de React js.
...
Como ya sabemos, React es uno de los frameworks(OJO, es libreria) JavaScript más usados en los últimos años. Los Props tiene una importante función: ellos **pasan los datos de un componente a otro, ofreciendo así un canal por el medio del cual los componentes se puede comunicar**.
...
-> otra opción es desestructurar las props asi no hay que poner props.:
